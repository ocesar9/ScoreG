...
@Composable
fun PlayingNowPage(navController: NavController, mainViewModel: MainViewModel, userListName: String) {
    ...
    Column(
        ...
        LazyColumn(
            ...
            items(mainViewModel.currentUserPlayingNowList.value.toList()) { game ->
